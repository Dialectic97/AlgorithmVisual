    ...
    $(document).keydown(function (e) {
        ...
        if (e.which === 13) {           // enter
            ...
            if (cmd === 'clear') {
                ...
                try {
                    let prefix = "parent.$(\"#Animation\")[0].contentWindow.";
                    //CommandResolve(cmd);
                    ans = eval(prefix + cmd);
                    //console.log(val_output)
                    if(ans == undefined) throw 0
...
// function CommandResolve(string) {
//     let AnimationWindow = parent.$("#Animation")[0].contentWindow;
//     //console.log(string);
//     if(/init(.*)/.test(string)) {
//         let ss = string.slice(5,string.length-1);
//         //console.log(ss);
//         let array = ss.split(",").map(Number);
//         //console.log(array)
        
//         AnimationWindow.init(array);
//         return true;

//     }
//     if(/sort()/.test(string)) {
//        // console.log("sort");
//        AnimationWindow.sort();
//     }

//     if(/next()/.test(string)) {
//         // console.log("sort");
//         AnimationWindow.next();
//      }
